...
/*   Updated: 2023/05/31 14:12:22 by TheTerror        ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_loader(t_vars *v)
{
	v->final = __TRUE;
	if (v->_1st > 0 && \
		v->_1st <= v->_2nd && v->_1st <= v->_3rd && v->_1st <= v->_1st2 && v->_1st <= v->_4th)
		ft_sort_small(v, __TRUE);
	else if (v->_1st2 > 0 && \
		v->_1st2 <= v->_2nd && v->_1st2 <= v->_3rd && v->_1st2 <= v->_1st && v->_1st2 <= v->_4th)
		ft_sort_small(v, __FALSE);
	else if (v->_2nd > 0 && \
		v->_2nd <= v->_1st && v->_2nd <= v->_3rd && v->_2nd <= v->_1st2 && v->_2nd <= v->_4th)
		ft_sort_bigone(v);
	else if (v->_3rd > 0 && \
		v->_3rd <= v->_2nd && v->_3rd <= v->_1st && v->_3rd <= v->_1st2 && v->_3rd <= v->_4th)
		ft_sort_typa(v);
	else
		ft_sort_bigtwo(v);
	ft_prcss_exit(v, EXIT_SUCCESS);
